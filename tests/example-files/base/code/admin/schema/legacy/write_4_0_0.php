...
function save_project(
  int $id,
  \codeneric\phmm\type\project_from_admin $data,
): void {
...
function get_thumbnail_meta(int $id): ?int {
...
function get_client_wp_user_id(int $clientID): ?int {
...
function save_comment(\codeneric\phmm\type\save_comment $comment): bool {
