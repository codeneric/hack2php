...
function map_client_from_3_6_5(
  Type\client_data_representation_3_6_5 $client_data_3_6_5,
  array<int> $project_ids,
// ): Type\client_data_representation_4_0_0 {
): \codeneric\phmm\type\client_from_client {
  $client_data_4_0_0 = shape();
  $client_data_4_0_0['project_access'] = [];
  foreach ($project_ids as $pid) {
    $client_data_4_0_0['project_access'][] = shape(
      'id' => $pid,
      'active' => true,
      'configuration' => null
    );
  ...
  $client_data_4_0_0['internal_notes'] =
    "Phone: ".
...
function map_project_from_3_6_5(
  Type\project_data_representation_3_6_5 $data_3_6_5,
  ?string $pwd,
  bool $watermark,
  ...
  $data_4_0_0['configuration'] = shape(
...
function map_comment_from_3_6_5(
  Type\comment_data_representation_3_6_5 $data_3_6_5,
  int $project_id,
  int $wp_user_id_of_client,
): \codeneric\phmm\type\save_comment {
...
function map_plugin_settings_from_3_6_5(
  Type\plugin_settings_data_representation_3_6_5 $data_3_6_5,
): \codeneric\phmm\type\plugin_settings {
  ...
  if (!is_null($es) && !is_null($ec)) {
    $data_4_0_0['canned_emails'][] = shape(
      'id' => "generated_".time(),
