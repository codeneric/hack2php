...
class Permission {
  public static function current_user_can_access_client(int $client_id): bool {
  ...
  public static function get_client_id_wrt_project(int $project_id): ?int {
  ...
  public static function get_project_state(int $projectID): projectState {
   ...
   */
  public static function display_project(int $projectID): display {
  ...
  public static function display_portal(): portalDisplay {
    if (Utils::is_current_user_admin())
   ...
   * Decider function what to display frontend for projects
   */
  public static function display_client(int $clientID): clientDisplay {
    if (Utils::is_current_user_admin())
  ...
  public static function post_password_required(int $post_id): bool {
