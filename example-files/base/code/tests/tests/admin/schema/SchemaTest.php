...
final class SchemaTest extends Codeneric_UnitTest {
  ...
  private function iterateCheck(
    array $datasets,
    codeneric\phmm\base\admin\schema\Schemas $schema,
  ) {
  ...
  public function testValidateCheckEmail() {
    $set = array(
      ...
      array(
        "assertion" => true,
        "data" => shape("email" => "hans", "client_id" => "123"),
      ),
      array(
        "assertion" => true,
        "data" => shape("email" => "hans", "client_id" => 123),
      ...
      array(
        "assertion" => false,
        "data" => shape("email" => 13456789, "client_id" => 123),
      ),
      array(
        "assertion" => false,
        "data" => shape("email" => "", "client_id" => 123),
      ),
    );
