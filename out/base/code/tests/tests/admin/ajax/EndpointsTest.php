...
class AjaxEndpointsTest extends WP_Ajax_UnitTestCase {
  ...
  private function makeCall($hook, $data = array()){
    $this->_last_response = '';
...
$msg,
  ...
  private function assertErrorsWithMessages($msgs, $res) {
  ...
  private function prepareClient($access) {
    $client =
      $this->factory
        ->post
        ->create_and_get(
